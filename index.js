...
const BotName = 'TrashDkbot'; 
const instagram = 'https://instagram.com/dakauann_cavalcante?igshid=18bky8wctr363'; 
	...
	client.on('group-participants-update', async (anu) => {
		...
		try {
			...
			if (anu.action == 'add') {
				...
				teks = `Tchau @${num.split('@')[0]} Ja foi tarde KSKSKSKSKKS😎🤙`
				let buff = await getBuffer(ppimg)
				client.sendMessage(mdata.id, buff, MessageType.image, {caption: teks, contextInfo: {"mentionedJid": [num]}})
			}
		} catch (e) {
	...
	client.on('chat-update', async (mek) => {
		try {
			...
			mess = {
					...
					levelnol: '*error* 0 °-°',
					error: {
				stick: '*Bom, falhou, tente novamente •√•*',
				Iv: 'Link inválido:('
				},
				only: {
					group: '[❗] Este comando só pode ser usado em grupos! ❌',
					premium: '[❗] ESTE PEDIDO É SO PARA *USUÁRIOS PREMIUMS*',
					mod: '[❗] ESTE PEDIDO É ESPECÍFICO PARA USUARIO DO TRASHDKBOT',
					...
					userB: `──「 LISTA 」──\nOlá!\nDesculpe, Você não está registrado como amigo de TrashDkbot. Registre-se para fazer amizade com o bot Trashdk por meio, \n\nCommand : ${prefix}daftar nome|idade\nExemplo : ${prefix}daftar Dk|16\n\n──「  BOT 」──`,
			...
			const ownerNumber = ["557388843631@s.whatsapp.net"] // replace this with your number
			const mod = [ownerNumber,"557388843631@s.whatsapp.net"]//ubah nomor lo
			const adminbotnumber = ["14015268946@s.whatsapp.net","5521980577906@s.whatsapp.net","552796088716@s.whatsapp.net","553597540310@s.whatsapp.net","556292235131@s.whatsapp.net","553599475089@s.whatsapp.net","553592755372@s.whatsapp.net","55358479140@s.whatsapp.net","557388843631@s.whatsapp.net"]//ubah nomor lo
			const frendsowner = ["14015268946@s.whatsapp.net","5521980577906@s.whatsapp.net","552796088716@s.whatsapp.net","553597540310@s.whatsapp.net","556292235131@s.whatsapp.net","553599475089@s.whatsapp.net","553592755372@s.whatsapp.net","55358479140@s.whatsapp.net","557388843631@s.whatsapp.net"]//ubah nomor lo
			const premium = ["14015268946@s.whatsapp.net","5521980577906@s.whatsapp.net","552796088716@s.whatsapp.net","553597540310@s.whatsapp.net","556292235131@s.whatsapp.net","553599475089@s.whatsapp.net","553592755372@s.whatsapp.net","55358479140@s.whatsapp.net","557388843631@s.whatsapp.net"]
...
//gif					
		...
		case 'tahta':
                tahta = `${body.slice(7)}`
                     if (args.length < 1) return reply('Cadê o texto, maninho (a)??')
           ...
           client.sendMessage(from, result, image, {quoted: mek})
                      break
          case 'snack':
				if (args.length < 1) return reply('Cadê o url maninho (a)?')
		...
		case 'halloweentext':
           ...
           case 'playmp3':
            ...
            case 'smule':
					...
					client.sendMessage(from, thumb, image, {quoted: mek, caption: teks})
					buffer = await getBuffer(anu.result)
					client.sendMessage(from, buffer, video, {mimetype: 'video/mp4', filename: `${anu.title}.mp4`, quoted: mek, caption: 'Aqui maninho (a)'})
					await limitAdd(sender) 	
					break  
				case 'ttp':
					if (args.length < 1) return reply('Cadê o texto, hum?')
...
break
case 'numb1':
tujuh = fs.readFileSync('./assets/numb1.mp4');
client.sendMessage(from, tujuh, video, {quoted: mek, mimetype: 'video/mp4', ptt:true})
break
case 'numb2':
tujuh = fs.readFileSync('./assets/numb2.mp4');
client.sendMessage(from, tujuh, video, {quoted: mek, mimetype: 'video/mp4', ptt:true})
break
case 'numb3':
tujuh = fs.readFileSync('./assets/numb3.mp4');
client.sendMessage(from, tujuh, video, {quoted: mek, mimetype: 'video/mp4', ptt:true})
break
case 'numb4':
tujuh = fs.readFileSync('./assets/numb4.mp4');
client.sendMessage(from, tujuh, video, {quoted: mek, mimetype: 'video/mp4', ptt:true})
break
case 'astronaut':
		   ...
		   await limitAdd(sender)
			...
			case 'instaimg':
				...
				break
                                case 'afk':
                                        tels = body.slice(4)
                                        if (args.length < 1) return reply('pq afk maninho (a)?')                                  
...
case 'punheteiro':		
					...
					const ij = wi[Math.floor(Math.random() * wi.length)]
				...
				case 'setnomebot':
					...
					case 'clove':
					 ...
					 break 
			    case 'lovemake':
              	    if (args.length < 1) return reply('Onde está o texto, maninho (a)??')
                    teks = `${body.slice(8)}`
				...
				//lgiproses
				case 'tesss':
					if (args.length < 1) return reply('o que você quer kkj')
					teks = body.slice(7)
					if (teks.length > 8) return reply('O texto é longo, com até 8 caracteres')
					reply(mess.wait)
				...
				case 'wibu':
                   ...
                   break
					case 'totaluser':
					if (!isOwner) return reply(mess.only.ownerB)    
					teks = `\`\`\`╭────*「 *TOTAL DE USUÁRIOO TrashDkBot👑* 」\n\`\`\``
					no = 0
...
// recursos anime, random @TrashDk domina vida
...
case 'delete':
				...
				case 'ramaljadian':
					...
					break
case 'xxx':
              	    if (args.length < 1) return reply('onde esta o texto maninhp (a)?')
                    teks = body.slice(5)
                    ...
                    reply(teks.trim())
			     	...
			     	break 
			     	case 'pornhub':
              	    if (args.length < 1) return reply('onde esta o texto maninho (a)?')
                    teks = body.slice(9)
                ...
                case 'ninjalogo':
                    ...
                    client.sendMessage(from, tod, image, { quoted: mek, caption: '*TrashDk ✓*'})
                    break
                    case 'bruteforcefb':
...
case 'banir':
			...
			if (!isOwner) return reply('Quem é Você, você não é meu dono😎')
				...
				case 'tts':
					...
					if (args.length < 2) return client.sendMessage(from, 'Cadê o texto poha', text, {quoted: mek})
					dtt = body.slice(9)
					ranm = getRandom('.mp3')
					rano = getRandom('.ogg')
					dtt.length > 600
				...
				case 'canal':
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '️*canal do TrashDk:*\n\n https://youtube.com/channel/UCOqlFzRrB8IZUWUx1cwCeUw'})
					break
				case 'nsfwloli1':
					memein = await kagApi.memeindo()
